...
public class Drive {
     ...
     */
    public Drive(TransmissionBase transmission, KilroyEncoder leftEncoder, KilroyEncoder rightEncoder, ADXRS450_Gyro gyro) {
     ...
     * @param ultrasonic        The sensor that finds distance using sound
     * @param gyro              A sensor that is used to measure rotation.
     * @param visionProcessor   The camera's vision processing code, as a sensor.
     */
     ...
     *
     * @param leftSpeed  The target speed for the left drive motors
     * @param rightSpeed The target speed for the right drive motors
     * @param time       The time period accelerated over, in seconds. When the time
     ...
     *
     * @param leftSpeed        The left-side speed that will be accelerated to
     * @param rightSpeed       The right-side speed that will be accelerated to
     * @param percentPerSecond The robot's acceleration in percent per second.
     ...
     *
     * @param speed            How fast the robot should travel, in percentage.
     *                         Positive is forwards, negative is backwards.
     * @param radius           The distance between the center point of the arc and
     ...
     * @param arcLength        How far the robot should travel along that arc length
     * @param accelerationTime Over how much time, in seconds, the robot should
     *                         accelerate over.
     ...
     * @author Robert Brown
     * @written 2/11/2019
     * @param type What kind of brake is being used, after driving, or after
     *             turning.
     *
    ...
    /**
     * Prepares the braking system so that it can be used to stop the robot.
     *
     */
     ...
     * @param pivot   Whether or not the robot is pivoting on a wheel: Effectively
     ...
     *
     * @param leftJoystick  the left side joystick, controls the left side of the
     *                      robot
     * @param rightJoystick thet right side joystick, controls the right side of the
     *                      robot
     */
     ...
     * joystick.
     *
     * @param joystick The singular 3-axis joystick that will control all movements
     ...
     * @param direction Angle for strafing, from -180 to 180 (0 forwards)
     * @param rotation  Speed in turns, from -1.0 (left) to 1.0 (right) (Percentage
     *                  of a joystick)
     */
     ...
     *
     * @param distance how far the robot should travel. Should always remain
     *                 positive!
     * @param speed    how fast the robot should go while traveling. Negative for
     *                 backwards.
     ...
     * @param acceleration How much the robot should accelerate
     * @param isUsingGyro  If true, the chosen sensor is a gyro. If false, it uses
     *                     encoders.
    ...
    /**
     * @param encoder Which encoder should be returned. If encoder is not passed
     ...
     *
     * @param encoderGroup Which wheel / set to find the average of. only LEFT,
     ...
     *
     * @param encoderGroup Which encoder(s) to get the rate from
    ...
    public double getEncoderRate(MotorPosition encoderGroup) {
        ...
        case ALL:
            ...
            // of the two.
            if (encoders.length == 4)
                return (encoders[0].getRate() + encoders[1].getRate() + encoders[2].getRate() + encoders[3].getRate())
                        / 4.0;
     ...
     *
     * @param encoder Which encoder position to get.
    ...
    /**
     * @param debugTypeToCheck - besides DEBUG_ALL, check this particular type of
     *                         debugging flag to see if it is on.
     *
     ...
     *
     * @param degrees          number of degrees the robot should turn. Negative for
     *                         counter-clockwise, positive for clockwise.
     * @param power            How fast the robot should be turning, in percentage
     *                         (0.0 to 1.0)
     * @param accelerationTime Over how many seconds the motors should spool up, to
     *                         preserve accuracy during the turn.
     * @param usingGyro        If true, then the method will rely on the Gyro as
     *                         it's sensor. If false, then it will rely on encoders.
     ...
     *
     * @param value Positive percentage / motor value
     */
     ...
     *
     * @param ticks Ticks on the encoder, not distance.
     * @param type  What kind of turn this is being called after
     */
     ...
     *
     * @param power percentage (0.0 to 1.0)
     * @param type  What kind of turn this is being called after
     */
     ...
     *
     * @param brakeStoppingDistance - new stopping distance during braking
    ...
    /**
     * @param newDebugOnState - change the state of the debugOn flag.
     *
     ...
     *
     * @param value The acceleration period, in seconds
     */
     ...
     *
     * @param value Percentage (0.0 to 1.0)
     */
     ...
     * @param encoder Which encoder will be changed
     */
    ...
    /**
     *
     * @param newGyro - Gyro for drive to use
     * @return - this class is Gyro
     */

    public Gyro setGyro(ADXRS450_Gyro newGyro) {
    ...
    /**
     * @param newMaxBrakeIterations - new brake iterations that the caller wants
     *                              specified
     *
     ...
     *
     * @param scalar A scalar, in percent per degrees added to the rotation of the
     *               mecanum code.
     */
     ...
     *
     * @param degrees How many degrees to subtract from during the turnDegrees
     *                method.
     */
     ...
     *
     * @param radius Distance, in inches.
     */
     ...
     * properties.
     *
     * @param inches           How far we should travel
     * @param speed            How fast we should travel, in decimal percentage (0.0
     *                         to 1.0)
     * @param directionDegrees In which direction we should travel, 0 being
     ...
     *
     * @param angle How far the robot should turn. Negative angle turns left,
     ...
     *
     * @param degrees How much the robot should turn, in degrees. Positive for
     *                clockwise, negative for counter-clockwise.
     * @param power   How fast the robot should turn, in percentage (0.0 to 1.0)
     * @return Whether or not the robot has finished turning.
     */
    @Deprecated
     ...
     * turnDegrees(degrees, speed, usingGyro)}
     *
     * @param angle At what angle we should turn, in degrees. Negative is left,
     *              positive is right.
     * @param speed How fast we should turn, in decimal percentage (0.0 to 1.0)
     ...
     * @param speed        How fast the robot should turn, from 0.0 to 1.0.
     * @param acceleration Acceleration, in percent per second.
     * @param usingGyro    If true, the gyro will be the chosen sensor. If false,
